...
public class ConstantUtil {
    ...
    public static final String START_MESSAGE = "Welcome aboard!\uD83E\uDD19\uD83E\uDD19 \nIf you press  the 'Driver\uD83D\uDE99'" +
            ...
            "If you press the 'List of my offers' button, you'll have the possibility to check your already created offers as a 'DRIVER', a 'PASSENGER' or a 'PARCEL' and change some data if necessary\n";
    ...
    public static final String START_FROM_THE_BEGINNING = "You can start from the beginning";
