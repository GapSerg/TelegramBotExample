...
public class SecondDateParcelCallbackType implements CallbackType {
    ...
    public BotApiMethod createSendMessage(CallbackQuery callbackQuery) {
        ...
        String textMessage = String.format(CHOSEN_SECOND_DATE, parcelRequest.getActivity(), getCurrentRoute(parcelRequest.getCities()),
                parcelRequest.getFirstDate(), parcelRequest.getSecondDate());
